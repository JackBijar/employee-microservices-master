package com.spring.cloud.consumer.employee;
...
import com.spring.cloud.consumer.employee.service.EmployeeService;
import com.spring.cloud.consumer.employee.service.EmployeeServiceImpl;
...
public class EmployeeConsumerApplication {
    ...
    public Docket api() throws IOException, XmlPullParserException {
        return new Docket(DocumentationType.SWAGGER_2)  
          .select() 
          .apis(RequestHandlerSelectors.basePackage("com.spring.cloud.consumer.employee.controller"))
	...
	private Predicate<String> postPaths() {
		return or(regex("/employee/getEmployees.*"), regex("/employee/getEmployeeFall.*"),
				regex("/employee/saveEmployee.*"), regex("/employee/getEmployee/.*"),
				regex("/employee/getEmployeeFall/.*"), regex("/employee/getEmployeeByEmail/.*"),
				regex("/employee/updateEmployee/.*"), regex("/deleteEmployee/.*"));
	}*/
